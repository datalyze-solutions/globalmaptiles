...
// 	console.log(lon, lat)
	...
	minx = this.PixelsToMeters( tx * this.tileSize, ty * this.tileSize, zoom )['mx']
	miny = this.PixelsToMeters( tx * this.tileSize, ty * this.tileSize, zoom )['my']
	maxx = this.PixelsToMeters( (tx + 1) * this.tileSize, (ty + 1) * this.tileSize, zoom )['mx']
	maxy = this.PixelsToMeters( (tx + 1) * this.tileSize, (ty + 1) * this.tileSize, zoom )['my']
